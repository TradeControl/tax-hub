...
using TradeControl.Tax.UK.Hmrc.MtdIncomeTax.v1_0.BusinessIncomeSummary.V3.Wire;

namespace TradeControl.Tax.UK.Hmrc.MtdIncomeTax.v1_0.BusinessIncomeSummary.V3;
