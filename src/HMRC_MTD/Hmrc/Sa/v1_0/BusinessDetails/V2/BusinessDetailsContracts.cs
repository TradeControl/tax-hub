...
using TradeControl.Tax.UK.Hmrc.Sa.v1_0.BusinessDetails.V2.Wire.list;
using TradeControl.Tax.UK.Hmrc.Sa.v1_0.BusinessDetails.V2.Wire.detail;
using TradeControl.Tax.UK.Hmrc.Sa.v1_0.BusinessDetails.V2.Wire.ladr;

namespace TradeControl.Tax.UK.Hmrc.Sa.v1_0.BusinessDetails.V2;
