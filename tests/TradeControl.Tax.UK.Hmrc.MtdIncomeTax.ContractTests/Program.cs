...
using CalculationResponse2025 = TradeControl.Tax.UK.Hmrc.MtdIncomeTax.v1_0.Calculations.V8.Wire2025.CalculationResponse2025;
using CalculationResponse2026 = TradeControl.Tax.UK.Hmrc.MtdIncomeTax.v1_0.Calculations.V8.Wire2026.CalculationResponse2026;
using BissWireResponse = TradeControl.Tax.UK.Hmrc.MtdIncomeTax.v1_0.BusinessIncomeSummary.V3.Wire.BissWireResponse;
using BusinessListWireResponse = TradeControl.Tax.UK.Hmrc.MtdIncomeTax.v1_0.BusinessDetails.V2.Wire.list.BusinessListWireResponse;
using BusinessDetailWireResponse = TradeControl.Tax.UK.Hmrc.MtdIncomeTax.v1_0.BusinessDetails.V2.Wire.detail.BusinessDetailWireResponse;
using LadrElectionWireResponse = TradeControl.Tax.UK.Hmrc.MtdIncomeTax.v1_0.BusinessDetails.V2.Wire.ladr.LadrElectionWireResponse;
...
Assert(typeof(TradeControl.Tax.UK.Hmrc.MtdIncomeTax.v1_0.Losses.V6.CreateLossClaimRequest) != typeof(TradeControl.Tax.UK.Hmrc.MtdIncomeTax.v1_0.Losses.V7.LossClaimsResource), "Loss v6 and v7 must remain distinct contract generations.");
